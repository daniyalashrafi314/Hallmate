...
import { Calendar, Globe, MapPin, Video, XCircle, Info, ExternalLink } from 'lucide-react';
...
const StaffEvents: React.FC = () => {
    ...
    const API_BASE = 'http://localhost:5000/staff/events';
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <p className="text-gray-500 mt-1">View upcoming inter-hall activities and exclusive events for your hall.</p>
            </div>
