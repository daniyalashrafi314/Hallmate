...
admin_forum_bp = Blueprint('admin_forum', __name__)
...
def get_current_hall_id(admin_id):
    result = execute_read_query(
        "SELECT hall_id FROM STAFFS WHERE staff_id = %s", (admin_id,)
    )
    return result[0]['hall_id'] if result else None


def get_user_id_for_admin(admin_id):
    result = execute_read_query(
        "SELECT user_id FROM STAFFS WHERE staff_id = %s", (admin_id,)
    )
...
@admin_forum_bp.route('/forum/posts', methods=['GET'])
@token_required(allowed_roles=['admin'])
def get_forum_posts():
    current_admin_id = request.current_user_id
    current_hall_id = get_current_hall_id(current_admin_id)
    current_user_id = get_user_id_for_admin(current_admin_id)
...
@admin_forum_bp.route('/forum/posts', methods=['POST'])
@token_required(allowed_roles=['admin'])
def create_post():
    current_admin_id = request.current_user_id
    current_hall_id = get_current_hall_id(current_admin_id)
...
@admin_forum_bp.route('/forum/posts/<int:post_id>', methods=['GET'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/posts/<int:post_id>', methods=['PUT'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/posts/<int:post_id>', methods=['DELETE'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/posts/<int:post_id>/like', methods=['POST'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/posts/<int:post_id>/comments', methods=['GET'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/posts/<int:post_id>/comments', methods=['POST'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/posts/<int:post_id>/comments/<int:comment_id>', methods=['DELETE'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/users/<string:user_id>/profile', methods=['GET'])
@token_required(allowed_roles=['admin'])
...
@admin_forum_bp.route('/forum/users/<string:user_id>/photo', methods=['GET'])
@token_required(allowed_roles=['admin'])
